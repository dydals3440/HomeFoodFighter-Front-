...
2. 다통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 알아볼 수 없는 형태로 가공하여 제공하는 경우
3. 관계 법령에 의하여 수사상 목적으로 정해진 절차와 방법에 따라 관계기관의 요구가 있는 경우
4. 다른 법률에 특별한 규정이 있는 경우
5. 방송통신심의위원회가 관계법령에 의하여 요청하는 경우
...
4. 서비스는 국가비상사태, 천재지변, 기타 정전 등 불가항력적 사유가 있는 경우 정상적인 서비스 이용에 지장이 있는 때에는 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.
5. 서비스가 통제하기 곤란한 사정으로 불가피하거나, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 때에는 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.
...
1. 다른 회원의 ID와 비밀번호, 주민등록번호, 사업자등록번호 등을 도용하는 행위
2. 본 서비스를 통하여 습득한 정보를 서비스의 사전승낙 없이 회원 본인의 이용 이외 다른 목적으로 복제하거나 이를 출판 및 방송 등에 사용하거나 제3자에게 제공하는 행위
3. 타인의 특허, 상표, 영업비밀, 저작권 기타 저작재산권을 침해하는 내용을 전송, 게시하거나, 전자메일 또는 기타의 방법으로 타인에게 유포하는 행위
4. 공공질서 및 미풍양속에 위반되는 저속, 음란한 내용의 정보, 문장, 도형 등을 전송, 게시하거나, 전자메일 또는 기타의 방법으로 타인에게 유포하는 행위
5. 모욕적이거나 위협적이어서 타인의 프라이버시를 침해할 수 있는 내용을 전송, 게시하거나, 전자메일 또는 기타의 방법으로 타인에게 유포하는 행위
6. 범죄와 결부된다고 객관적으로 판단되는 행위
7. 서비스의 승인을 받지 않고 다른 사용자의 개인정보를 수집 또는 저장하는 행위
8. 기타 관계법령에 위배되는 행위
제 4 장 서비스 이용
제 13 조 (서비스 이용 범위)
...
4. 서비스의 저작권, 제 3 자의 저작권 등 기타 권리를 침해하는 내용인 경우
5. 서비스에서 규정한 게시기간이나 용량을 초과한 경우
...
4. 서비스, 다른 회원 또는 제 3자의 저작재산권을 침해하는 경우
...
11. 서비스를 이용하여 얻은 정보를 서비스의 사전 승낙 없이 복제 또는 유통시키거나 상업적으로 이용하는 경우
12. 회원이 음란물을 게재하거나 음란 사이트를 링크하는 경우
13. 본 약관을 포함하여 기타 서비스가 정한 이용 조건에 위반한 경우
제 6 장 손해배상 및 기타 사항
제 21 조 (손해배상)
